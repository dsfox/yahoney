...
const TEXT_ORDER_REMOVED = " удален из списка заказов";
...
bot.on("text", function(msg) {
    ...
    if (cid !== ADMIN_ID || fakeUser) { //handle new user commands
        ...
        if (mText === "/subscribers") {
        ...
        } else if (mText.indexOf("/remove") == 0) {
            ...
            answer(cid, found ? yid + TEXT_ORDER_REMOVED : ERROR_ORDER_REMOVE);
        } else if (mText === "/info") {
